...
if(isset($_POST["btnsubmit"]))
{
    ...
    $iscurrant="yes";
    $roleid=7;
	 $qry="UPDATE member SET username='$username',pwd='$pwd',fname='$fname',lname='$lname',mpic='$mpic',gen='$gen' houseid='$houseid',cno='$cno',email='$email',adharno='$adharno',dob='$dob',doannivarsary='$doannivarsary',jobtype='$jobtype',doj='$doj',isactive='$isactive',iscurrent='$iscurrent',roleid='$roleid'  where mid='$id'" ;
...
<u><h3 class="display-4 py-2 text-truncate"><b>SOCIETY MANAGEMENT SYSTEM</b></h3> </u>
